...
public class ModifiedStat implements Stat{
    ...
    private String s1;
    private int score, modifier;
    private char type;
    
    public ModifiedStat(StatContainer i, String stat, int mod) {
        this(i, stat, mod, '*');
    }
    
    public ModifiedStat(StatContainer i, String stat, int mod, char type) {
        this.i = i;
        s1 = stat;
        modifier = mod;
        this.type = type;
    ...
    public ModifiedStat(String s1, int mod) {
        this(s1, mod, '*');
    }
    
    public ModifiedStat(String s1, int mod, char type) {
        this.s1 = s1;
        modifier = mod;
        this.type = type;
    }
